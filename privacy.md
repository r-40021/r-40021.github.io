...
- template: detail-content
  ...
  headline: 開発者が得ている情報
  content: |-
    <p>開発者は、「Google Search Console」と「Counter」の2つのサービスを利用して、個人を特定できない形でユーザーのアクセス状況を収集しています。収集した情報は、より使いやすいサービスを開発する目的で利用します。</p>
    ...
    <p>そこで、ユーザーのプライバシーを保護しつつ必要な情報を収集できるサービスを探したところ、「Counter」というものを見つけました。このサービスでは、アクセス数や使用しているプラットフォーム <small>(Windows、iPhone など)</small> 、ブラウザ、画面の大きさ、アクセス元の国・Web サイトなどの情報を得ることができます。また、Google のシステムを利用している検索エンジンを経由せずにアクセスした場合もカウントの対象となります。</p>

    <p>しかし、これは「どのドアから、何人の人が店に入ってきたのかを数えるようなもの」(*1)で、ユーザーを「追跡」しているわけではありません。(引用元は別サービスのWebサイトですが、どちらもユーザーを追跡していないことに変わりはありません。)</p>
